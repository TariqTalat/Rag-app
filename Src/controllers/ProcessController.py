...
2. Define the ProcessController class for file processing logic.
3. Initialize controller with project-specific paths.
4. Implement file extension extraction.
5. Implement file loader selection based on type.
6. Implement file content extraction.
7. Implement file chunking for RAG operations.
...
class ProcessController(BaseController):
    ...
    text chunking, and document management. Inherits from BaseController.
    ...
    Example usage:
        >>> pc = ProcessController('proj1')
        >>> content = pc.get_file_content('file1.txt')
        >>> chunks = pc.process_file_content('file1.txt', content, 100, 20)
    """
    ...
    def __init__(self, project_id: str):
        ...
        super().__init__()
        # Step 2: Store project identifier for operations
        self.project_id = project_id
        # Step 3: Get project directory path for file access
    ...
    def get_file_extension(self, file_id: str):
        ...
        Example usage:
            >>> pc = ProcessController('proj1')
            >>> ext = pc.get_file_extension('file1.txt')
            '.txt'
        """
        # Step 1: Extract and normalize file extension
    ...
    def get_file_loader(self, file_id: str):
        ...
        Example usage:
            >>> pc = ProcessController('proj1')
            >>> loader = pc.get_file_loader('file1.txt')
        """
        # Step 1: Get file extension for type detection
        file_ext = self.get_file_extension(file_id=file_id)
        # Step 2: Construct full file path
        file_path = os.path.join(self.project_path, file_id)
        # Step 3: Return appropriate loader based on file type
        if file_ext == ProcessingEnum.TXT.value:
            return TextLoader(file_path, encoding='utf-8')
        if file_ext == ProcessingEnum.PDF.value:
            return PyMuPDFLoader(file_path)
        # Step 4: Return None for unsupported file types
        return None
    ...
    def get_file_content(self, file_id: str):
        ...
        Example usage:
            ...
            >>> content = pc.get_file_content('file1.txt')
        """
        # Step 1: Get appropriate loader for file type
        loader = self.get_file_loader(file_id=file_id)
        # Step 2: Load and return file content
        return loader.load()
    ...
    def process_file_content(self, file_id: str, file_content: list, chunk_size: int = 100, chunk_overlap: int = 20):
        ...
        Example usage:
            ...
            >>> chunks = pc.process_file_content('file1.txt', content, 100, 20)
        """
        # Step 1: Initialize text splitter with specified parameters
        text_splitter = RecursiveCharacterTextSplitter(
            chunk_size=chunk_size,
            chunk_overlap=chunk_overlap,
            length_function=len
        )
        # Step 2: Extract text content from document objects
        file_content_texts = [rec.page_content for rec in file_content]
        # Step 3: Extract metadata from document objects
        file_content_metadata = [rec.metadata for rec in file_content]
        # Step 4: Create chunks from text content with metadata
